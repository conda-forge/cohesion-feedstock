...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cohesion-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14473&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cohesion-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cohesion` can be installed with:

```
conda install cohesion
```

It is possible to list all of the versions of `cohesion` available on your platform with:
